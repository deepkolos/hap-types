...
declare module '@system.media' {
  interface Media {
     ...
     * 
     */
    takePhoto(OBJECT: TakePhotoOBJECT): void;
     ...
     * 
     */
    takeVideo(OBJECT: TakeVideoOBJECT): void;
     ...
     * 
     */
    pickImage(OBJECT: PickImageOBJECT): void;
     ...
     * 
     */
    pickImages(OBJECT: PickImagesOBJECT): void;
     ...
     * 
     */
    pickVideo(OBJECT: PickVideoOBJECT): void;
     ...
     * 
     */
    pickVideos(OBJECT: PickVideosOBJECT): void;
     ...
     * 
     */
    pickFile(OBJECT: PickFileOBJECT): void;
     ...
     * 
     */
    saveToPhotosAlbum(OBJECT: SaveToPhotosAlbumOBJECT): void;
     ...
     * 
     */
    previewImage(OBJECT: PreviewImageOBJECT): void;
     ...
     * 
     */
    getRingtone(OBJECT: GetRingtoneOBJECT): void;
     ...
     * 
     */
    setRingtone(OBJECT: SetRingtoneOBJECT): void;
  }
   ...
   * 成功回调
   */
  type GetRingtoneOBJECTSuccessCB = (successArg: GetRingtoneSuccessSuccessArg) => any;
   ...
   * 成功回调
   */
  type PickVideosOBJECTSuccessCB = (successArg: PickVideosSuccessSuccessArg) => any;
   ...
   * 成功回调
   */
  type PickVideoOBJECTSuccessCB = (successArg: PickVideoSuccessSuccessArg) => any;
   ...
   * 成功回调
   */
  type PickImagesOBJECTSuccessCB = (successArg: PickImagesSuccessSuccessArg) => any;
   ...
   * 成功回调
   */
  type PickImageOBJECTSuccessCB = (successArg: PickImageSuccessSuccessArg) => any;
   ...
   */
  type TakeVideoOBJECTSuccessCB = (successArg: TakeVideoSuccessSuccessArg) => any;
   ...
   * 成功回调
   */
  type TakePhotoOBJECTSuccessCB = (successArg: TakePhotoSuccessSuccessArg) => any;
