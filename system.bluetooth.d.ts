...
declare module '@system.bluetooth' {
  interface Bluetooth {
     ...
     * 
     */
    openAdapter(OBJECT: OpenAdapterOBJECT): void;
     ...
     * 
     */
    closeAdapter(OBJECT: CloseAdapterOBJECT): void;
     ...
     * 
     */
    getAdapterState(OBJECT: GetAdapterStateOBJECT): void;
     ...
     * 
     */
    startDevicesDiscovery(OBJECT: StartDevicesDiscoveryOBJECT): void;
     ...
     * 
     */
    stopDevicesDiscovery(OBJECT: StopDevicesDiscoveryOBJECT): void;
     ...
     * 
     */
    getDevices(OBJECT: GetDevicesOBJECT): void;
     ...
     * 
     */
    getConnectedDevices(OBJECT: GetConnectedDevicesOBJECT): void;
     ...
     * 
     */
    createBLEConnection(OBJECT: CreateBLEConnectionOBJECT): void;
     ...
     * 
     */
    closeBLEConnection(OBJECT: CloseBLEConnectionOBJECT): void;
     ...
     * 
     */
    getBLEDeviceServices(OBJECT: GetBLEDeviceServicesOBJECT): void;
     ...
     * 
     */
    getBLEDeviceCharacteristics(OBJECT: GetBLEDeviceCharacteristicsOBJECT): void;
     ...
     * 
     */
    readBLECharacteristicValue(OBJECT: ReadBLECharacteristicValueOBJECT): void;
     ...
     * 
     */
    writeBLECharacteristicValue(OBJECT: WriteBLECharacteristicValueOBJECT): void;
     ...
     * 
     */
    notifyBLECharacteristicValueChange(OBJECT: NotifyBLECharacteristicValueChangeOBJECT): void;
  }
   ...
   * 成功回调。
   */
  type GetBLEDeviceCharacteristicsOBJECTSuccessCB = (successArg: GetBLEDeviceCharacteristicsSuccessSuccessArg) => any;
   ...
   * 成功回调。
   */
  type GetBLEDeviceServicesOBJECTSuccessCB = (successArg: GetBLEDeviceServicesSuccessSuccessArg) => any;
   ...
   * 成功回调。
   */
  type GetConnectedDevicesOBJECTSuccessCB = (successArg: GetConnectedDevicesSuccessSuccessArg) => any;
   ...
   * 成功回调。
   */
  type GetDevicesOBJECTSuccessCB = (successArg: GetDevicesSuccessSuccessArg) => any;
   ...
   * 成功回调。
   */
  type GetAdapterStateOBJECTSuccessCB = (successArg: GetAdapterStateSuccessSuccessArg) => any;
