...
declare module '@service.share' {
  interface Share {
     ...
     * 
     */
    getAvailablePlatforms(OBJECT: GetAvailablePlatformsOBJECT): void;
  }
   ...
   * 成功回调
   */
  type GetAvailablePlatformsOBJECTSuccessCB = (successArg: GetAvailablePlatformsSuccessSuccessArg) => any;
   ...
   * @param platforms 分享到的平台，不填则默认分享所有平台。可用值包括：WEIBO(新浪微博)、QQ、WEIXIN(微信好友)、WEIXIN_CIRCLE(微信朋友圈)、SYSTEM(系统分享)
