...
declare module '@system.geolocation' {
  interface Geolocation {
     ...
     * 
     */
    getLocation(OBJECT: GetLocationOBJECT): void;
     ...
     * 
     */
    getLocationType(OBJECT: GetLocationTypeOBJECT): void;
   ...
   * @param coordType 坐标系类型，可选值可通过 getSupportedCoordTypes 获取，默认为 wgs84
   ...
   * 每次位置信息发生变化，都会被回调
   */
  type SubscribeOBJECTCallbackCB = (callbackArg: SubscribeCallbackCallbackArg) => any;
   ...
   * 成功回调
   */
  type GetLocationTypeOBJECTSuccessCB = (successArg: GetLocationTypeSuccessSuccessArg) => any;
   ...
   * 成功回调
   */
  type GetLocationOBJECTSuccessCB = (successArg: GetLocationSuccessSuccessArg) => any;
